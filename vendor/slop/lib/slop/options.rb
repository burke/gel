...
module Gel::Vendor::Slop
  class Options
    ...
    # Example:
    #
    #   opts = Gel::Vendor::Slop.parse do |o|
    #     o.on '--version' do
    #       puts Gel::Vendor::Slop::VERSION
    #     end
    #   end
    #
    #   opts.to_hash #=> {}
    ...
    def on(*flags, **config, &block)
      ...
      klass  = Gel::Vendor::Slop.string_to_option_class(config[:type].to_s)
    ...
    def respond_to_missing?(name, include_private = false)
      Gel::Vendor::Slop.option_defined?(name) || super
    end
